...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "create_card":
        ...
        if not ads:
            await query.message.reply_text("\U0001f4c1 \u041d\u0435\u0442 \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u0439. \u041e\u043f\u0438\u0448\u0438 \u0442\u043e\u0432\u0430\u0440!")
            return
        text = "\U0001f4c1 \u041c\u041e\u0418 \u041e\u0411\u042a\u042f\u0412\u041b\u0415\u041d\u0418\u042f\n\n"
        buttons = []
        for ad in ads:
        ...
        await query.message.reply_text("\U0001f4cb \u041a\u043e\u043f\u0438\u0440\u0443\u0439 \u0442\u0435\u043a\u0441\u0442:\n\n%s" % text)
    elif data == "photo_tips" and state.get("last_card"):
        tips = state["last_card"].get("photo_tips", "\u0421\u043e\u0432\u0435\u0442\u044b \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u044b")
        await query.message.reply_text("\U0001f4f8 \u0421\u041e\u0412\u0415\u0422\u042b \u041f\u041e \u0424\u041e\u0422\u041e:\n\n%s" % tips)
