...
GEMINI_API_KEY = "AIzaSyCKyL09e1eVN-sgn0eWrEbAXZURHVWZbco"
...
Когда пользователь описывает товар или присылает фото создай карточку ТОЛЬКО в формате JSON без каких либо других слов:
