...
OPENROUTER_API_KEY = "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"
        ...
        try:
            ...
            response = httpx.post(
                ...
                headers={
                    ...
                    "HTTP-Referer": "https://t.me/AvitoHelperBot",
                },
                json={
                    "model": model,
                    "messages": [
            ...
            data = response.json()
            logger.info(f"Data: {str(data)[:300]}")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (f"Привет {u.first_name}!\n\n"
            ...
            f"Отправь описание товара текстом!")
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "show_help":
        ...
        await query.message.reply_text("Опиши новый товар текстом!")
